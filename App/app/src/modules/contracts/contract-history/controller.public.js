...
class ContractsContractHistoryCtrl extends BaseController {
...
ContractsContractHistoryCtrl.$inject = ['$scope', '$injector', 'stateData'];

export default ContractsContractHistoryCtrl