...
class BaseController {
    constructor($scope, $injector) {
        ...
        this.$viewModels.fkeyModels['$cachedbeContract.ttContractFK1DSModel'] = {};
        this.$ds['beContract.ttContractFK1DS'] = new kendo.data.DataSource({
            "transport": this.$dataProviderService.getTransport('ProjectData', {
                "jsdo": "beContract"
            }),
            ...
            change: function(e) {
                ...
                if (ds.filter() && ds.filter().filters.length > 0) {
                    if (view.length > 0) {
                        that.$viewModels.fkeyModels['$cachedbeContract.ttContractFK1DSModel'] = view[0];
                    } else {
                        that.$viewModels.fkeyModels['$cachedbeContract.ttContractFK1DSModel'] = {};
                    }
                } else {
                    that.$scope.$applyAsync(function() {
                        that.$viewModels.fkeyModels['beContract.ttContractFK1DSModel'] = that.$viewModels.fkeyModels['$cachedbeContract.ttContractFK1DSModel'];
                    });
                }
            }
        });
        ...
        this._$createPristineModel('beContract.ttContractFK1DS');
        this._$watchForeignKeyModel('beContract.ttContractFK1DSModel', 'ContractNr', 'ContractNr');
        ...
        this.$model = {
            ...
            customSections: {
                top: 'views.payments.new-payment.topSection.html',
                middle: 'views.payments.new-payment.middleSection.html',
                bottom: 'views.payments.new-payment.bottomSection.html'
            },
            events: {
                onRowSelect: (e) => {
        ...
        this.$components['ctl29'] = {
            widget: null,
            options: {
                dataSource: this.$ds['beContract.ttContractFK1DS'],
                dataTextField: "ContractNr",
                dataValueField: "ContractNr",
    ...
    _$createSelection() {
        ...
        this.$ds['beContract.ttContractFK1DS'].query({
            filter: {
                field: 'ContractNr',
                operator: "eq",
                value: this.$viewModels.formModel['ContractNr']
            }
        }).then(() => {
            this.$ds['beContract.ttContractFK1DS'].filter({});
        });
